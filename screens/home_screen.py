    ...
    MDBoxLayout:
        ...
        MDBoxLayout:
            ...
            MDIconButton:
                icon: "history"
                theme_icon_color: "Custom"
                icon_color: 0.533, 0.573, 0.643, 1
            ...
            MDBoxLayout:
                ...
                MDCard:
                    ...
                    MDBoxLayout:
                        ...
                        # Progress bar for current magnitude
                        MDProgressBar:
                            id: magnitude_bar
                            value: 50
                            color: 0, 0.831, 1, 1
...
class HomeScreen(Screen):
    ...
    def _update_ui(self, dt):
        ...
        if self.fall_detector and self.is_monitoring:
            ...
            phase_colors = {
                "IDLE":      (0, 0.902, 0.463, 1),
                "FREEFALL":  (1, 0.702, 0, 1),
                "IMPACT":    (1, 0.231, 0.361, 1),
                "STILLNESS": (1, 0.231, 0.361, 1),
            }
            self.ids.phase_label.text = phase
            self.ids.phase_label.text_color = phase_colors.get(phase, (1,1,1,1))

            # Progress bar (normalized 0-40 m/s²)
            self.ids.magnitude_bar.value = min(100, (mag / 40.0) * 100)

            # Activity
            activity_map = {
                "still":   "Standing still or resting",
                "walking": "Walking — monitoring active",
                "active":  "Active movement detected",
                "unknown": "Analyzing movement...",
            }
    ...
    def _on_fall_detected(self):
        """Called by FallDetector when fall is confirmed"""
    ...
    def _update_countdown_label(self):
        ...
        if self.countdown <= 5:
            self.ids.countdown_label.text_color = (1, 0.231, 0.361, 1)
    ...
    def cancel_alert(self):
        """User pressed "I'm Okay" — cancel the alert"""
    ...
    def send_alert_now(self):
        ...
        self.alert_service.send_emergency_alerts(
            location=location,
            on_complete=self._on_alerts_sent
        )
    ...
    def manual_sos(self):
        dialog = MDDialog(
            ...
            text="This will immediately alert all your emergency contacts with your current location.",
            buttons=[
                MDFlatButton(
                    text="CANCEL",
                    theme_text_color="Custom",
    ...
    def _do_manual_sos(self):
        location = self.gps_service.get_location() if self.gps_service else {}
        self.alert_service.send_emergency_alerts(location=location,
                                                  on_complete=self._on_alerts_sent)
